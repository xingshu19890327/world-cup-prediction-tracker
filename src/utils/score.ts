...
export const recalculateMatch = (m: MatchPrediction): MatchPrediction => {
  ...
  if (!raw) {
    ...
    return { ...m, actualResult: '', chatgptActualWinner: '', completionStatus: '未赛', claudeAnyScoreHit: '待赛', claudeWdlHit: '待赛', chatgptAnyScoreHit: '待赛', chatgptWdlHit: '待赛', predictionDisagreement: disagreement, highOddsTag: oddsHigh(m) ? '高赔率' : m.highOddsTag };
  }
